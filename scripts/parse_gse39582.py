...
MATRIX_GZ = "GSE39582_series_matrix.txt.gz"
PLATFORM = "GPL570.txt"
...
print("Probes parsed:", len(probe2gene))
...
clinical_df.to_csv("gse39582_clinical.csv")
...
print("Extracted expression submatrix shape:", expr_df.shape)
expr_df.to_csv("gse39582_target_probe_expr.csv")
